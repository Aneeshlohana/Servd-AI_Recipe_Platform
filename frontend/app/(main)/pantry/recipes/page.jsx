      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <ChefHat className="w-16 h-16 text-green-600" style={{ backgroundColor: "#16a34a", color: "white" }} />
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-stone-900 tracking-tight">
                What Can I Cook?
              </h1>
              <p className="text-stone-600 font-light" style={{ color: "#57534e", fontWeight: 300 }}>
