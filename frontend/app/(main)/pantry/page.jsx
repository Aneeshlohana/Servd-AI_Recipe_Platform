      ...
      <div className="container mx-auto max-w-5xl">
        ...
        {items.length > 0 && (
          <Link href="/pantry/recipes" className="block mb-8">
            <div className="bg-linear-to-br from-green-600 to-emerald-500 text-white p-6 border-2 border-emerald-700 hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer group" style={{ background: 'linear-gradient(to bottom right, #16a34a, #10b981)' }}>
