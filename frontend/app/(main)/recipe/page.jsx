...
function RecipeContent() {
  ...
  className="border-2 text-white gap-2 transition-all"
  style={{
    backgroundColor: isSaved ? "#16a34a" : "#ea580c", // green-600 / orange-600
    borderColor: isSaved ? "#15803d" : "#c2410c",     // green-700 / orange-700
  }}
  onMouseEnter={(e) => {
            ...
            <div className="bg-white p-8 border-2 border-stone-200">
              ...
              <div>
                {recipe.instructions.map((step, index) => (
                  ...
                  >
                    {/* Step Number */}
                    <div className="absolute -left-5 top-1 w-5 h-5 bg-orange-600 text-white flex items-center justify-center font-bold border-2 border-orange-700">
                      {step.step}
                    </div>
